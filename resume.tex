...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     \textbf{AI \& ML:} TensorFlow, PyTorch, Computer Vision, NLP, Scikit-learn, NumPy, Pandas, Matplotlib \\
     \textbf{Programming:} Python, Java, JavaScript, SQL, HTML, CSS \\
     \textbf{Web Technologies:} React, Next.js, Spring Boot, Node.js, REST APIs \\
     \textbf{DevOps \& Tools:} Git, Docker, CI/CD Pipelines, Kubernetes \\
     \textbf{Databases:} MySQL, MongoDB, JPA/Hibernate \\
